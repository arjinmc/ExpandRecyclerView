...
public abstract class RecyclerViewGroupTypeProcessor<E> {
    ...
    /**
     * Callback {@link androidx.recyclerview.widget.RecyclerView.Adapter} onBindViewHolder for group type
     *
    ...
    /**
     * Callback {@link androidx.recyclerview.widget.RecyclerView.Adapter} onBindViewHolder for item type
     *
     * @param holder        viewHolder
     * @param groupPosition the position of the group
